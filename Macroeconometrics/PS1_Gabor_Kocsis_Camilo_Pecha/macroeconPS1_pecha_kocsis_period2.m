...
% USING DATA FOR THE PERIOD 1984-2004
...
%for 1 lag
X1=[cons XLAG(109:i,2) XLAG(109:i,3)];
%ols 
...
cons=ones(length(y),1);
%for 2 lags
X2=[cons XLAG2(109:i,2) XLAG2(109:i,3)];
%ols 
...
cons=ones(length(y),1);
%for 1 lag
X1=[cons XLAG4(109:i,2)];
%for 2 lags
X2=[cons XLAG4(109:i,2) XLAG4(109:i,3)];
%for 3 lags
X3=[cons XLAG4(109:i,2) XLAG4(109:i,3) XLAG4(109:i,4)];
%for 4 lags
X4=[cons XLAG4(109:i,2) XLAG4(109:i,3) XLAG4(109:i,4) XLAG4(109:i,5)];
%ols 
...
yhat4h4=X4*phi4h4;
yobs=y(i-109,1);
yfor4h4=yhat4h4(i-109,1);
eb4h4(i,1)=(yobs-yfor4h4)^2;
end

epsAR1h4=eb1h4(149:232);
mseAR1h4=mean(epsAR1h4);

epsAR2h4=eb2h4(149:232);
mseAR2h4=mean(epsAR2h4);

epsAR4h4=eb4h4(149:232);
...
cons=ones(length(y),1);
%for 1 lag
X1=[cons XLAG(109:i,2) XLAG(109:i,3) u(109:i,1) XLAGu(109:i,2) XLAGu(109:i,3)];
%ols 
...
cons=ones(length(y),1);
%for 2 lags
X2=[cons XLAG2(109:i,2) XLAG2(109:i,3) u(109:i,1) XLAGu2(109:i,2) XLAGu2(109:i,3)];
%ols 
...
cons=ones(length(y),1);
%for 1 lag
X1=[cons XLAG4(109:i,2) u(109:i,1) XLAGu4(109:i,2)];
%for 2 lags
X2=[cons XLAG4(109:i,2) XLAG4(109:i,3) u(109:i,1) XLAGu4(109:i,2) XLAGu4(109:i,3)];
%for 3 lags
X3=[cons XLAG4(109:i,2) XLAG4(109:i,3) XLAG4(109:i,4) u(109:i,1) XLAGu4(109:i,2) XLAGu4(109:i,3) XLAGu4(109:i,4)];
%for 4 lags
X4=[cons XLAG4(109:i,2) XLAG4(109:i,3) XLAG4(109:i,4) XLAG4(109:i,5) u(109:i,1) XLAGu4(109:i,2) XLAGu4(109:i,3) XLAGu4(109:i,4) XLAGu4(109:i,5)];
%ols 
...
epsPC_u1h4=eb1h4(149:232);
msePC_u1h4=mean(epsPC_u1h4);

epsPC_u2h4=eb2h4(149:232);
msePC_u2h4=mean(epsPC_u2h4);

epsPC_u4h4=eb4h4(149:232);
...
cons=ones(length(Y),1);
%for 1 lag
X1=[cons XLAG(109:i,2) XLAG(109:i,3) XLAGy(109:i,2) XLAGy(109:i,3)];
%ols 
...
cons=ones(length(Y),1);
%for 2 lags
X2=[cons XLAG2(109:i,2) XLAG2(109:i,3) XLAGy2(109:i,2) XLAGy2(109:i,3)];
%ols 
...
cons=ones(length(Y),1);
%for 1 lag
X1=[cons XLAG4(109:i,2) XLAGy4(109:i,2)];
%for 2 lags
X2=[cons XLAG4(109:i,2) XLAG4(109:i,3) XLAGy4(109:i,2) XLAGy4(109:i,3)];
%for 3 lags
X3=[cons XLAG4(109:i,2) XLAG4(109:i,3) XLAG4(109:i,4) XLAGy4(109:i,2) XLAGy4(109:i,3) XLAGy4(109:i,4)];
%for 4 lags
X4=[cons XLAG4(109:i,2) XLAG4(109:i,3) XLAG4(109:i,4) XLAG4(109:i,5) XLAGy4(109:i,2) XLAGy4(109:i,3) XLAGy4(109:i,4) XLAGy4(109:i,5)];
%ols 
...
epsPC_dy1h4=eb1h4(149:232);
msePC_dy1h4=mean(epsPC_dy1h4);

epsPC_dy2h4=eb2h4(149:232);
msePC_dy2h4=mean(epsPC_dy2h4);

epsPC_dy4h4=eb4h4(149:232);
